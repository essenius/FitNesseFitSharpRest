...
namespace RestTests
{
    ...
    public class ContentHandlerTests
    {
        ...
        public void ContentHandlerObsoleteTest()
        {
            ...
            var obj2 = h.CreateObjectFromTypeInAssembly("xml", "RestTests.FewTypes", "RestCoreTests.dll");
            var obj3 = h.CreateObjectFromTypeInAssemblyWithParams("xml", "RestTests.FewTypes", "RestCoreTests.dll", new[] {"true"});
        ...
        {
            var h = new ContentHandler();
            var obj = h.ObjectFromTypeInAssembly("xml", "RestTests.FewTypes", "RestCoreTests.dll");
        ...
        {
            var h = new ContentHandler();
            var obj = h.ObjectFromTypeInAssemblyWithParams("xml", "RestTests.FewTypes", "RestCoreTests.dll",
                new[] {"true"});
            Assert.AreEqual(
        ...
        {
            var classCollection = ContentHandler.ClassesIn("RestCoreTests.dll");
